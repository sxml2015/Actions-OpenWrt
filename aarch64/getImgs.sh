...
# Files 标签 ID 获取 （F大打包文件） https://api.github.com/repos/sxml2015/Actions-OpenWrt/releases/latest
wget $(curl -s https://api.github.com/repos/sxml2015/Actions-OpenWrt/releases/138624163 | grep browser_download_url | cut -d '"' -f 4)
