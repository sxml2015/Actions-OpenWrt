...
#ID获取 https://api.github.com/repos/sxml2015/Actions-OpenWrt/releases/latest
wget $(curl -s https://api.github.com/repos/sxml2015/Actions-OpenWrt/releases/41755208 | grep browser_download_url | cut -d '"' -f 4)
